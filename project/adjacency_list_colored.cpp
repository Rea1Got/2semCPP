...
AdjacencyListColored::AdjacencyListColored(std::vector<std::vector<std::pair<int, int>>> adjacencyListGraph) \
                                              : color(std::vector<int>()), previousVertex(std::vector<int>()){
    ...
    distance.assign(adjacencyListGraph.size(), -1);  //like prev comment
}
